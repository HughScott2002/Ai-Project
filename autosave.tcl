...
#  Nov 26, 2023 06:53:41 PM EST  platform: Windows NT
set vTcl(timestamp) ""
...
proc vTclWindow.top1 {base} {
    ...
    wm geometry $top 600x450+980+210
    update
    # set in toplevel.wgt.
    global vTcl
    global img_list
...
### SPOT dump_widget_opt A
    label "$top.lab49" \
        ...
        -text "Academic Probation Alert Python and Prolog Project" 
...
### SPOT dump_widget_opt A
    label "$top.lab50" \
        ...
        -disabledforeground #a3a3a3 -font "TkDefaultFont" \
        -foreground $vTcl(actual_gui_fg) \
        -text "University of Technology, Jamaica" 
...
### SPOT dump_widget_opt A
    ...
    ###################
    place $top.lab49 \
        -in $top -x 0 -relx 0.267 -y 0 -rely 0.044 -width 0 -relwidth 0.507 \
        -height 0 -relheight 0.136 -anchor nw -bordermode ignore 
    place $top.lab50 \
        -in $top -x 0 -relx 0.467 -y 0 -rely 0.022 -width 0 -relwidth 0.407 \
